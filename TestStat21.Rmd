...
```
Hvis p-værdien er under 0.05 forkastes nulhypotesen, og der er altså statistisk signifikans for alternativhypotesen. I dette tilfælde er p-værdien 0.28, og man vil altså ikke kunne konkludere at der var forkel på om hhv. mænd og kvinder mener at der er for få toiletter på matematisk institut.
...
```
Nu er p-værdien meget lille (under 0.05), og man kan altså konkludere at der er forskel på andelen af hhv. mænd og kvinder på BSS der mener, at der er for få toiletter på matematisk institut, selvom det er de samme andele der har svaret ja som tidligere. Dette handler om stikprøvestørrelsen.
...
Vi skal huske at vi skal holde antallet af gange indvandre nævnes op mod hovr mange ord der er i alt.
```{r}
df_efter_1995 %>%
...
Vi får nu en større p-værdi, og data strider derfor ikke imod vores nulhypotese.
